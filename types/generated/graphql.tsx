...
/** columns and relationships of "profiles" */
export type ProfilesUser_AggregateArgs = {
  distinct_on?: Maybe<Array<Users_Select_Column>>;
  limit?: Maybe<Scalars['Int']>;
  offset?: Maybe<Scalars['Int']>;
  order_by?: Maybe<Array<Users_Order_By>>;
...
export type Profiles_Bool_Exp = {
  ...
  user?: Maybe<Users_Bool_Exp>;
  user_aggregate?: Maybe<Users_Aggregate_Bool_Exp>;
};
...
export type GetUsersIdQuery = { __typename?: 'query_root', users: Array<{ __typename?: 'users', id: any }> };
...
export type GetUsersByIdQuery = { __typename?: 'query_root', users_by_pk?: { __typename?: 'users', id: any, name: string, created_at: any } | null };
...
export const GetUsersIdDocument = gql`
    query GetUsersId {
  users(order_by: {created_at: desc}) {
    id
  }
...
/**
 * __useGetUsersIdQuery__
 *
 * To run a query within a React component, call `useGetUsersIdQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetUsersIdQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetUsersIdQuery({
 *   variables: {
 *   },
 * });
 */
